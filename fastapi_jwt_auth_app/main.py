...
from fastapi.security import OAuth2PasswordBearer # extracts JWT token from Authorization header
from fastapi.security import OAuth2PasswordRequestForm # parses login form
from jose import jwt, JWTError # for encoding and decoding JWT tokens
from passlib.context import CryptContext # for hashing and verifying passwords using bcrypt
